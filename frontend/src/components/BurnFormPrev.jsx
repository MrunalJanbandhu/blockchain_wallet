...
export default function BurnForm() {
  ...
  const res = await axios.post('https://localhost:4000/token/burn', {from: to, amount },{
	headers: { 'x-wallet-address': admin }
});
  ...
  return (
	...
	<inpur type="text" placeholder="Admin address" className="input" value={admin} onChange={(e) => setAdmin(e.target.value)} />
